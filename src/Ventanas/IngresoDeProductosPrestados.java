...
public class IngresoDeProductosPrestados extends javax.swing.JInternalFrame {
    /*************************Atributos**********************/ 
    ...
    public String numdoc(){
        String dat="";
        int a=0;
        control.Sql="select count(*) from doc_compra where tipo='Prestado';";
        dat=control.DevolverRegistroDto(control.Sql, 1);
        if(dat.compareTo("0")==0){
            a=1;
        }else{
            control.Sql="select serie from doc_compra where tipo='Prestado'  order by iddoc_compra desc limit 1"; 
    ...
    public void RegistrarIngreso(){
     if(tProductosingresar.getRowCount()>0){
      ...
      fe=control.Formato_Amd(fecha.getDate());
      control.Sql="call insertarprestamosuno('1','"+fe+"','"+idpres+"');";
     cod= control.DevolverRegistroDto(control.Sql, 1);control.fila=0;String nudoc=numdoc();
      control.Sql="SELECT InsertaCompra(curdate(),'"+idProv+"','"+nudoc+
       "','"+nudoc+"','Prestado')";      
   ...
   if(tProductosingresar.getValueAt(control.fila,4).toString().equals("Meses")){
       ...
       control.Sql="select idproducto from producto where codbrr='"+codbr+"';";
       String cc = control.DevolverRegistroDto(control.Sql, 1);
       control.fila++;
       //JOptionPane.showMessageDialog(rootPane, control.Sql);
       
       control.Sql="insert into prestamoproducto (idprestamo,idproducto)values('"+cod+"','"+cc+"');";
       control.CrearRegistro(control.Sql);
    ...
    public void LimpiarDatos1(){
     jLabel1.setText(null);txCosto.setText(null);txGarantia.setText(null);   
    ...
    public void LimpiarDatos2(){
     LimpiarDatos1();control.LimTabla(modelo2);
     txBuscarproveedores.grabFocus();
    }
    public void Cancelar(){
     LimpiarDatos1();jLabel5.setText(null);
     tProveedores.clearSelection();control.LimTabla(modelo2);    
     txBuscarproveedores.grabFocus();
    }
    ...
    public void GeneraCodigoProducto(){
     ...
     if(tProveedores.getSelectedRow()<0)
      ...
      ltr=control.ObtenerDato("proveedor","idproveedor","0",5);cod=ltr+"_"+fech;
    ...
    public IngresoDeProductosPrestados() {
     initComponents();setTitle("Ingreso de productos Prestados");     this.setFrameIcon(new ImageIcon(this.getClass().getResource("/Imagenes/icoChiqui.png")));
     tProveedores.setModel(modelo); modelo.setColumnIdentifiers(new String[]{"Código","Prestador","Responsable"});       
     ...
     tProductosingresar.getColumnModel().getColumn(0).setPreferredWidth(200);
     tProductosingresar.getColumnModel().getColumn(1).setPreferredWidth(250);
     tProductosingresar.getColumnModel().getColumn(5).setPreferredWidth(50);
     jLabel5.setText(" ");jLabel1.setText(" ");rb.setVisible(false);bAgregar.setVisible(false);     
     rb1.setVisible(false);MostrarProveedores();MostrarCatalogo();fecha.setDate(new Date());     
    }
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        jPanel5.add(bSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 90, 50));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        jPanel6.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, 20));
        ...
        jPanel6.add(fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 170, 20));

        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 510, 310, 90));

        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Código de barras", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        jPanel3.add(txcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 130, -1));
        ...
        jPanel3.add(rbNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, -1, -1));
