...
/********** VerDeudores.java** Created on 04-feb-2014, 15:07:14  ***/
package Ventanas;import Clases.*;import com.toedter.calendar.JDateChooser;
import java.beans.PropertyChangeEvent;import java.lang.reflect.Field;import java.util.Date;
import javax.swing.ImageIcon;import javax.swing.JOptionPane;import javax.swing.JPopupMenu;

/******* @author Ing Miguel Angel Silva  Zapata********/
public class Rpt_DeudasCanceladas extends javax.swing.JInternalFrame {
   /*****************************LOS ATRIBUTOS*****************************/ 
   ...
   /*****************************LOS METODOS*****************************/ 
    public void BuscarDeudores(){
     control.Sql="SELECT iddeuda,nomclie,fono, fecvta,fecdeud, montdeu, pgoinici,tipcompr,nume  FROM deudores  where   nomclie like'%"
     +txtBuscar.getText()+"%' and montdeu=0 and fecvta between'"+control.Formato_Amd(f_Desde.getDate())+"' and '"+
     control.Formato_Amd(F_Hasta.getDate())+"';";control.LlenarJTabla(modelo,control.Sql,9);
    }
    public void Imprimir(){
      control.impresor.Imprimircon5Parametros("Deudas Canceladas","DeudasCanceladas","buscar","fdesde","fhasta","fdesdevta","fhastavta",
    ...
    public void MostrarDeudores1(){
     ...
     control.Sql="SELECT iddeuda,nomclie,fono, fecvta,fecdeud, montdeu, pgoinici,tipcompr,nume  FROM deudores  where   nomclie like'%...3434------"
      + "%' and montdeu='4377373477730';";control.LlenarJTabla(modelo,control.Sql,9);
    }    
    public void PonerFechaActual(){
     f_Desde.setDate( new Date());F_Hasta.setDate( new Date());   
    }
    public Rpt_DeudasCanceladas() {
     initComponents();setTitle("Las Deudas Canceladas");
     this.setFrameIcon(new ImageIcon(this.getClass().getResource("/Imagenes/icoChiqui.png")));tDeudores.setModel(modelo);
     modelo.setColumnIdentifiers(new String[] {"Orden","cliente","Telefono","Fecha Venta","Fecha Pago","Deuda","Pago Inicial","Comprobante","Numero"});     
     tDeudores.getColumnModel().getColumn(0).setPreferredWidth(50);tDeudores.getColumnModel().getColumn(1).setPreferredWidth(200);
     tDeudores.getColumnModel().getColumn(2).setPreferredWidth(80);tDeudores.getColumnModel().getColumn(3).setPreferredWidth(80);
     tDeudores.getColumnModel().getColumn(4).setPreferredWidth(80);tDeudores.getColumnModel().getColumn(5).setPreferredWidth(80);
     tDeudores.getColumnModel().getColumn(6).setPreferredWidth(80);control.forma_table_ver(modelo, tDeudores);PonerFechaActual();
     //MostrarDeudores();
   ...
   /*****************************LOS METODOS*****************************/ 
    ...
    private void initComponents() {
        ...
        jPanel2.add(bSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 7, 114, 45));
        ...
        jPanel2.add(bImprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 7, 114, 45));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 920, 60));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 39, 890, 294));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 920, 346));
